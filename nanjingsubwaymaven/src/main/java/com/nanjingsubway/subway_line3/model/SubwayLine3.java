package com.nanjingsubway.subway_line3.model;

public class SubwayLine3 {
	...
	public SubwayLine3(Integer siteNumber, String siteName, String siteDetails, String transfered,
	...
	public SubwayLine3(Integer siteId, Integer siteNumber, String siteName, String siteDetails, String transfered,
			String transferedLines, String recharged, String toilet) {
		super();
		this.siteId = siteId;
		this.siteNumber = siteNumber;
