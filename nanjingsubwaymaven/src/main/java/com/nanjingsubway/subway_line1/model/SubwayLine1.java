package com.nanjingsubway.subway_line1.model;

public class SubwayLine1 {
	...
	public SubwayLine1(Integer siteNumber, String siteName, String siteDetails, String transfered,
	...
	public SubwayLine1(Integer siteId, Integer siteNumber, String siteName, String siteDetails, String transfered,
			String transferedLines, String recharged, String toilet) {
		super();
		this.siteId = siteId;
		this.siteNumber = siteNumber;
