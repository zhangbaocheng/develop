package com.nanjingsubway.subway_lines8.model;

public class SubwayLines8 {
	...
	public SubwayLines8(Integer siteNumber, String siteName, String siteDetails, String transfered,
	...
	public SubwayLines8(Integer siteId, Integer siteNumber, String siteName, String siteDetails, String transfered,
			String transferedLines, String recharged, String toilet) {
		super();
		this.siteId = siteId;
		this.siteNumber = siteNumber;
