package com.nanjingsubway.subway_line2.model;
...
public class SubwayLine2 {
	...
	public SubwayLine2(Integer siteNumber, String siteName, String siteDetails, String transfered,
	...
	public SubwayLine2(Integer siteId, Integer siteNumber, String siteName, String siteDetails, String transfered,
			String transferedLines, String recharged, String toilet) {
		super();
		this.siteId = siteId;
		this.siteNumber = siteNumber;
