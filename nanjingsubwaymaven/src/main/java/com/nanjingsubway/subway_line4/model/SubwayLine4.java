package com.nanjingsubway.subway_line4.model;

public class SubwayLine4 {
	...
	public SubwayLine4(Integer siteNumber, String siteName, String siteDetails, String transfered,
	...
	public SubwayLine4(Integer siteId, Integer siteNumber, String siteName, String siteDetails, String transfered,
			String transferedLines, String recharged, String toilet) {
		super();
		this.siteId = siteId;
		this.siteNumber = siteNumber;
